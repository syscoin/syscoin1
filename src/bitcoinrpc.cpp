...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  ...
  { "certissuerscan",        &certissuerscan,    false,      true,      true },
  { "certissuerclean",       &certissuerclean,   false,      true,      true },
  { "certissuerfilter",      &certissuerfilter,  false,      true,      true },
