...
public:
     ...
     */
    QString addRow(const QString &type, const QString &offer, const QString &value, const QString &height,const QString &price, const QString &currency, const QString &qty, const QString &total, const QString &status);
...
public slots:
     ...
     */
    void updateEntry(const QString &offer, const QString &value, const QString &height,const QString &price, const QString &currency, const QString &qty, const QString &total, const QString &status, OfferAcceptModelType type, int statusi);
