...
!define COMPANY "SysCoin project"
!define URL http://www.syscoin.org/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/syscoin.ico"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER SysCoin
...
OutFile syscoin-0.8.6.2-win32-setup.exe
...
VIAddVersionKey ProductName SysCoin
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/syscoin-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/syscoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\SysCoin.lnk" $INSTDIR\syscoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall SysCoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall SysCoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\SysCoin.lnk"
